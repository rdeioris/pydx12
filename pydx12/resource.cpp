...
PYDX12_TYPE(D3D12_TEXTURE_COPY_LOCATION, PyObject* py_pResource);
...
static void pydx12_D3D12_TEXTURE_COPY_LOCATION_dealloc_wrapper(pydx12_D3D12_TEXTURE_COPY_LOCATION* self)
{
	if (self->data->pResource)
		self->data->pResource->Release();
	pydx12_D3D12_TEXTURE_COPY_LOCATION_dealloc(self);
}
...
static void pydx12_D3D12_RESOURCE_UAV_BARRIER_dealloc_wrapper(pydx12_D3D12_RESOURCE_UAV_BARRIER* self)
{
	if (self->data->pResource)
		self->data->pResource->Release();
	pydx12_D3D12_RESOURCE_UAV_BARRIER_dealloc(self);
}
...
static void pydx12_D3D12_RESOURCE_ALIASING_BARRIER_dealloc_wrapper(pydx12_D3D12_RESOURCE_ALIASING_BARRIER* self)
{
	if (self->data->pResourceBefore)
		self->data->pResourceBefore->Release();
	if (self->data->pResourceAfter)
		self->data->pResourceAfter->Release();
	pydx12_D3D12_RESOURCE_ALIASING_BARRIER_dealloc(self);
}

PYDX12_TYPE(D3D12_RESOURCE_TRANSITION_BARRIER, PyObject* py_pResource);
...
static void pydx12_D3D12_RESOURCE_TRANSITION_BARRIER_dealloc_wrapper(pydx12_D3D12_RESOURCE_TRANSITION_BARRIER* self)
{
	if (self->data->pResource)
		self->data->pResource->Release();
	pydx12_D3D12_RESOURCE_TRANSITION_BARRIER_dealloc(self);
}
...
int pydx12_init_resource(PyObject* m)
{
	...
	pydx12_D3D12_TEXTURE_COPY_LOCATIONType.tp_dealloc = (destructor)pydx12_D3D12_TEXTURE_COPY_LOCATION_dealloc_wrapper;
	PYDX12_REGISTER_STRUCT(D3D12_TEXTURE_COPY_LOCATION);

	pydx12_D3D12_RESOURCE_UAV_BARRIERType.tp_dealloc = (destructor)pydx12_D3D12_RESOURCE_UAV_BARRIER_dealloc_wrapper;
	PYDX12_REGISTER_STRUCT(D3D12_RESOURCE_UAV_BARRIER);

	pydx12_D3D12_RESOURCE_ALIASING_BARRIERType.tp_dealloc = (destructor)pydx12_D3D12_RESOURCE_ALIASING_BARRIER_dealloc_wrapper;
	PYDX12_REGISTER_STRUCT(D3D12_RESOURCE_ALIASING_BARRIER);

	pydx12_D3D12_RESOURCE_TRANSITION_BARRIERType.tp_dealloc = (destructor)pydx12_D3D12_RESOURCE_TRANSITION_BARRIER_dealloc_wrapper;
