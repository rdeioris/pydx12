...
PYDX12_BUFFER_GETTER_SETTER(D3D12_SUBOBJECT_TO_EXPORTS_ASSOCIATION, pSubobjectToAssociate, D3D12_STATE_SUBOBJECT);
...
PYDX12_GETSETTERS(D3D12_SUBOBJECT_TO_EXPORTS_ASSOCIATION) = {
	PYDX12_DECLARE_GETTER_SETTER_CHUNK(D3D12_SUBOBJECT_TO_EXPORTS_ASSOCIATION, pSubobjectToAssociate),
