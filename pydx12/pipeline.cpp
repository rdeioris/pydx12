...
PYDX12_ADD_REFS(D3D12_INPUT_ELEMENT_DESC) { printf("traccking SemanticName %p\n", data->SemanticName);  PYDX12_INCREF(D3D12_INPUT_ELEMENT_DESC, data->SemanticName); }
PYDX12_RELEASE_REFS(D3D12_INPUT_ELEMENT_DESC) { printf("untraccking SemanticName %p\n", data->SemanticName); PYDX12_DECREF(D3D12_INPUT_ELEMENT_DESC, data->SemanticName); }
