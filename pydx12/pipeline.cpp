...
PYDX12_TYPE(D3D12_INPUT_ELEMENT_DESC, PyObject* py_SemanticName);
...
PYDX12_TYPE(D3D12_CACHED_PIPELINE_STATE, PyObject* py_CachedBlob);
...
static void pydx12_D3D12_CACHED_PIPELINE_STATE_dealloc_wrapper(pydx12_D3D12_CACHED_PIPELINE_STATE* self)
{
	Py_XDECREF(self->py_CachedBlob);
	pydx12_D3D12_CACHED_PIPELINE_STATE_dealloc(self);
}
...
int pydx12_init_pipeline(PyObject* m)
{
	...
	pydx12_D3D12_CACHED_PIPELINE_STATEType.tp_dealloc = (destructor)pydx12_D3D12_CACHED_PIPELINE_STATE_dealloc_wrapper;
