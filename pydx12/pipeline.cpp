...
PYDX12_TYPE_WITH_REFS(D3D12_INPUT_ELEMENT_DESC, PyObject* py_SemanticName);
PYDX12_ADD_REFS(D3D12_INPUT_ELEMENT_DESC) { PYDX12_INCREF(D3D12_INPUT_ELEMENT_DESC, py_SemanticName); }
PYDX12_RELEASE_REFS(D3D12_INPUT_ELEMENT_DESC) { PYDX12_DECREF(D3D12_INPUT_ELEMENT_DESC, py_SemanticName); }
...
static void pydx12_D3D12_INPUT_LAYOUT_DESC_dealloc_wrapper(pydx12_D3D12_INPUT_LAYOUT_DESC* self)
{
	if (self->data->pInputElementDescs)
		PyMem_Free((void*)self->data->pInputElementDescs);
	pydx12_D3D12_INPUT_LAYOUT_DESC_dealloc(self);
}
...
PYDX12_TYPE_WITH_REFS(D3D12_CACHED_PIPELINE_STATE, PyObject* py_CachedBlob);
PYDX12_ADD_REFS(D3D12_CACHED_PIPELINE_STATE) { PYDX12_INCREF(D3D12_CACHED_PIPELINE_STATE, py_CachedBlob); }
PYDX12_RELEASE_REFS(D3D12_CACHED_PIPELINE_STATE) { PYDX12_DECREF(D3D12_CACHED_PIPELINE_STATE, py_CachedBlob); }
PYDX12_BUFFER_GETTER_SETTER(D3D12_CACHED_PIPELINE_STATE, pCachedBlob, CachedBlobSizeInBytes, py_CachedBlob);
...
int pydx12_init_pipeline(PyObject* m)
{
	...
	pydx12_D3D12_INPUT_LAYOUT_DESCType.tp_dealloc = (destructor)pydx12_D3D12_INPUT_LAYOUT_DESC_dealloc_wrapper;
