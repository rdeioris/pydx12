...
PYDX12_GETSETTERS(D3D12_STATE_SUBOBJECT) = {
	...
	PYDX12_DECLARE_GETTER_SETTER(D3D12_STATE_SUBOBJECT, pDesc),
	{ NULL }  /* Sentinel */
};
...
PYDX12_TYPE(D3D12_SUBOBJECT_TO_EXPORTS_ASSOCIATION);
PYDX12_PTR_GETTER_SETTER(D3D12_SUBOBJECT_TO_EXPORTS_ASSOCIATION, pSubobjectToAssociate, D3D12_STATE_SUBOBJECT);
PYDX12_GETTER_SETTER(D3D12_SUBOBJECT_TO_EXPORTS_ASSOCIATION, NumExports, UnsignedLong, UINT);
PYDX12_WSTRING_ARRAY_GETTER_SETTER(D3D12_SUBOBJECT_TO_EXPORTS_ASSOCIATION, pExports);
PYDX12_GETSETTERS(D3D12_SUBOBJECT_TO_EXPORTS_ASSOCIATION) = {
	PYDX12_DECLARE_GETTER_SETTER(D3D12_SUBOBJECT_TO_EXPORTS_ASSOCIATION, pSubobjectToAssociate),
	PYDX12_DECLARE_GETTER_SETTER(D3D12_SUBOBJECT_TO_EXPORTS_ASSOCIATION, NumExports),
	PYDX12_DECLARE_GETTER_SETTER_CHUNK(D3D12_SUBOBJECT_TO_EXPORTS_ASSOCIATION, pExports),
	{ NULL }  /* Sentinel */
};

PYDX12_TYPE(D3D12_STATE_OBJECT_DESC);
PYDX12_GETTER_SETTER(D3D12_STATE_OBJECT_DESC, Type, LongLong, D3D12_STATE_OBJECT_TYPE);
PYDX12_GETTER_SETTER(D3D12_STATE_OBJECT_DESC, NumSubobjects, UnsignedLong, UINT);
PYDX12_STRUCT_ARRAY_GETTER_SETTER(D3D12_STATE_OBJECT_DESC, pSubobjects, D3D12_STATE_SUBOBJECT);
PYDX12_GETSETTERS(D3D12_STATE_OBJECT_DESC) = {
	PYDX12_DECLARE_GETTER_SETTER(D3D12_STATE_OBJECT_DESC, Type),
	PYDX12_DECLARE_GETTER_SETTER(D3D12_STATE_OBJECT_DESC, NumSubobjects),
	PYDX12_DECLARE_GETTER_SETTER_CHUNK(D3D12_STATE_OBJECT_DESC, pSubobjects),
	{ NULL }  /* Sentinel */
};

PYDX12_TYPE(D3D12_RAYTRACING_PIPELINE_CONFIG);
PYDX12_GETTER_SETTER(D3D12_RAYTRACING_PIPELINE_CONFIG, MaxTraceRecursionDepth, UnsignedLong, UINT);
PYDX12_GETSETTERS(D3D12_RAYTRACING_PIPELINE_CONFIG) = {
	PYDX12_DECLARE_GETTER_SETTER(D3D12_RAYTRACING_PIPELINE_CONFIG, MaxTraceRecursionDepth),
	{ NULL }  /* Sentinel */
};


PYDX12_TYPE_COM(ID3D12PipelineState);
PYDX12_TYPE_COM(ID3D12StateObject);
...
int pydx12_init_pipeline(PyObject* m)
{
	...
	PYDX12_REGISTER_STRUCT(D3D12_SUBOBJECT_TO_EXPORTS_ASSOCIATION);
	PYDX12_REGISTER_STRUCT(D3D12_STATE_OBJECT_DESC);
	PYDX12_REGISTER_STRUCT(D3D12_RAYTRACING_PIPELINE_CONFIG);

	PYDX12_REGISTER_COM(ID3D12PipelineState, ID3D12Pageable);
	PYDX12_REGISTER_COM(ID3D12StateObject, ID3D12Pageable);
	...
	PYDX12_ENUM(D3D12_STATE_OBJECT_TYPE_COLLECTION);
	PYDX12_ENUM(D3D12_STATE_OBJECT_TYPE_RAYTRACING_PIPELINE);

	PYDX12_ENUM(D3D12_RAYTRACING_MAX_ATTRIBUTE_SIZE_IN_BYTES);
