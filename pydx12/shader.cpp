...
PYDX12_TYPE(D3D_SHADER_MACRO, PyObject* py_Name; PyObject* py_Definition);
PYDX12_STRING_GETTER_SETTER(D3D_SHADER_MACRO, Name, py_Name);
PYDX12_STRING_GETTER_SETTER(D3D_SHADER_MACRO, Definition, py_Definition);
PYDX12_GETSETTERS(D3D_SHADER_MACRO) = {
	PYDX12_DECLARE_GETTER_SETTER(D3D_SHADER_MACRO, Name),
	PYDX12_DECLARE_GETTER_SETTER(D3D_SHADER_MACRO, Definition),
	{ NULL }  /* Sentinel */
};
static void pydx12_D3D_SHADER_MACRO_dealloc_wrapper(pydx12_D3D_SHADER_MACRO* self)
{
	Py_XDECREF(self->py_Name);
	Py_XDECREF(self->py_Definition);
	pydx12_D3D_SHADER_MACRO_dealloc(self);
}

PYDX12_TYPE(D3D12_SHADER_BYTECODE, PyObject* py_ShaderByteCode);
PYDX12_BUFFER_GETTER_SETTER(D3D12_SHADER_BYTECODE, pShaderBytecode, BytecodeLength, py_ShaderByteCode);
PYDX12_GETTER_SETTER(D3D12_SHADER_BYTECODE, BytecodeLength, UnsignedLongLong, SIZE_T);
PYDX12_GETSETTERS(D3D12_SHADER_BYTECODE) = {
	PYDX12_DECLARE_GETTER_SETTER(D3D12_SHADER_BYTECODE, pShaderBytecode),
	PYDX12_DECLARE_GETTER_SETTER(D3D12_SHADER_BYTECODE, BytecodeLength),
	{ NULL }  /* Sentinel */
};
static void pydx12_D3D12_SHADER_BYTECODE_dealloc_wrapper(pydx12_D3D12_SHADER_BYTECODE* self)
{
	Py_XDECREF(self->py_ShaderByteCode);
	pydx12_D3D12_SHADER_BYTECODE_dealloc(self);
}
...
{
	pydx12_D3D_SHADER_MACROType.tp_dealloc = (destructor)pydx12_D3D_SHADER_MACRO_dealloc_wrapper;
	PYDX12_REGISTER_STRUCT(D3D_SHADER_MACRO);

	pydx12_D3D12_SHADER_BYTECODEType.tp_dealloc = (destructor)pydx12_D3D12_SHADER_BYTECODE_dealloc_wrapper;
