...
PYDX12_TYPE_WITH_REFS(D3D_SHADER_MACRO, PyObject* py_Name; PyObject* py_Definition);
PYDX12_ADD_REFS(D3D_SHADER_MACRO) { PYDX12_INCREF(D3D_SHADER_MACRO, py_Name); PYDX12_INCREF(D3D_SHADER_MACRO, py_Definition); }
PYDX12_RELEASE_REFS(D3D_SHADER_MACRO) { PYDX12_DECREF(D3D_SHADER_MACRO, py_Name); PYDX12_DECREF(D3D_SHADER_MACRO, py_Definition); }
...
PYDX12_TYPE_WITH_REFS(D3D12_SHADER_BYTECODE, PyObject* py_ShaderByteCode);
PYDX12_ADD_REFS(D3D12_SHADER_BYTECODE) { PYDX12_INCREF(D3D12_SHADER_BYTECODE, py_ShaderByteCode); }
PYDX12_RELEASE_REFS(D3D12_SHADER_BYTECODE) { PYDX12_DECREF(D3D12_SHADER_BYTECODE, py_ShaderByteCode); }
