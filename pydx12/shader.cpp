...
PYDX12_TYPE_WITH_REFS(D3D_SHADER_MACRO);
PYDX12_ADD_REFS(D3D_SHADER_MACRO) { PYDX12_INCREF(D3D_SHADER_MACRO, data->Name); PYDX12_INCREF(D3D_SHADER_MACRO, data->Definition); }
PYDX12_RELEASE_REFS(D3D_SHADER_MACRO) { PYDX12_DECREF(D3D_SHADER_MACRO, data->Name); PYDX12_DECREF(D3D_SHADER_MACRO, data->Definition); }
...
PYDX12_TYPE_WITH_REFS(D3D12_SHADER_BYTECODE);
PYDX12_ADD_REFS(D3D12_SHADER_BYTECODE) { PYDX12_INCREF(D3D12_SHADER_BYTECODE, data->pShaderBytecode); }
PYDX12_RELEASE_REFS(D3D12_SHADER_BYTECODE) { PYDX12_DECREF(D3D12_SHADER_BYTECODE, data->pShaderBytecode); }
